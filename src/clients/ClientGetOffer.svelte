        ...
        const resp = fetch(endpoint, requestOptions)
            .then((response) => {
                ...
                if (response.ok) {
                    ...
                    throw new Error("Error al consumir el servicio getOffer");
                }
            })
            .then((result) => {
                console.log(result);
